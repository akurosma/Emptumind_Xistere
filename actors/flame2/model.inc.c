...
// 0x030172E0
static const Vtx green_flame_seg3_vertex_030172E0[] = {
...
// 0x03017320
ALIGNED8 static const Texture green_flame_seg3_texture_03017320[] = {
#include "actors/flame/flame_0.ia16.inc.c"
};

// 0x03017B20
ALIGNED8 static const Texture green_flame_seg3_texture_03017B20[] = {
#include "actors/flame/flame_1.ia16.inc.c"
};

// 0x03018320
ALIGNED8 static const Texture green_flame_seg3_texture_03018320[] = {
#include "actors/flame/flame_2.ia16.inc.c"
};

// 0x03018B20
ALIGNED8 static const Texture green_flame_seg3_texture_03018B20[] = {
#include "actors/flame/flame_3.ia16.inc.c"
};

// 0x03019320
ALIGNED8 static const Texture green_flame_seg3_texture_03019320[] = {
#include "actors/flame/flame_4.ia16.inc.c"
};

// 0x03019B20
ALIGNED8 static const Texture green_flame_seg3_texture_03019B20[] = {
#include "actors/flame/flame_5.ia16.inc.c"
};

// 0x0301A320
ALIGNED8 static const Texture green_flame_seg3_texture_0301A320[] = {
#include "actors/flame/flame_6.ia16.inc.c"
};

// 0x0301AB20
ALIGNED8 static const Texture green_flame_seg3_texture_0301AB20[] = {
#include "actors/flame/flame_7.ia16.inc.c"
};

// 0x0301B320 - 0x0301B3B0
const Gfx green_flame_seg3_dl_0301B320[] = {
    gsSPClearGeometryMode(G_LIGHTING | G_SHADING_SMOOTH),
    gsDPSetEnvColor(255, 255, 0, 200),
...
const Gfx green_flame_seg3_dl_0301B3B0[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03017320),
    gsSPBranchList(green_flame_seg3_dl_0301B320),
};

// 0x0301B3C8 - 0x0301B3E0
const Gfx green_flame_seg3_dl_0301B3C8[] = {
    gsDPPipeSync(),
...
const Gfx green_flame_seg3_dl_0301B3E0[] = {
    gsDPPipeSync(),
...
const Gfx green_flame_seg3_dl_0301B3F8[] = {
    gsDPPipeSync(),
...
const Gfx green_flame_seg3_dl_0301B410[] = {
    gsDPPipeSync(),
...
const Gfx green_flame_seg3_dl_0301B428[] = {
    gsDPPipeSync(),
...
const Gfx green_flame_seg3_dl_0301B440[] = {
    gsDPPipeSync(),
...
const Gfx green_flame_seg3_dl_0301B458[] = {
    gsDPPipeSync(),
...
const Gfx pink_flame_seg3_dl_0301B470[] = {
    gsSPClearGeometryMode(G_LIGHTING | G_SHADING_SMOOTH),
    gsDPSetEnvColor(137, 255, 74, 255),
    gsDPSetCombineMode(G_CC_FADEA, G_CC_FADEA),
    gsDPSetTile(G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const Gfx pink_flame_seg3_dl_0301B500[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03017320),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};

// 0x0301B518 - 0x0301B530
const Gfx pink_flame_seg3_dl_0301B518[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03017B20),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
...
const Gfx pink_flame_seg3_dl_0301B530[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03018320),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
...
const Gfx pink_flame_seg3_dl_0301B548[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03018B20),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
...
const Gfx pink_flame_seg3_dl_0301B560[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03019320),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
...
const Gfx pink_flame_seg3_dl_0301B578[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_03019B20),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
...
const Gfx pink_flame_seg3_dl_0301B590[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_0301A320),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
...
const Gfx pink_flame_seg3_dl_0301B5A8[] = {
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_16b, 1, flame_seg3_texture_0301AB20),
    gsSPBranchList(pink_flame_seg3_dl_0301B470),
};
