void scroll_hmc_dl_TIE_Area1_v2_8_mesh_layer_1_vtx_24() {
	int i = 0;
	int count = 17;
	int width = 32 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(hmc_dl_TIE_Area1_v2_8_mesh_layer_1_vtx_24);
...
void scroll_hmc_dl_TIE_Area1_v2_8_mesh_layer_1_vtx_25() {
	int i = 0;
	int count = 24;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(hmc_dl_TIE_Area1_v2_8_mesh_layer_1_vtx_25);
...
void scroll_hmc() {
	scroll_hmc_dl_TIE_Area1_v2_8_mesh_layer_1_vtx_24();
	scroll_hmc_dl_TIE_Area1_v2_8_mesh_layer_1_vtx_25();
