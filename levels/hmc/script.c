...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		WARP_NODE(0x19, LEVEL_HMC, 0x01, 0x20, WARP_NO_CHECKPOINT),
		WARP_NODE(0x20, LEVEL_HMC, 0x01, 0x19, WARP_NO_CHECKPOINT),
		...
		//blenderでモデル名設定必要
		OBJECT(MODEL_WF_RL_MARKER, -10783, 1650, -10112, 0, 0, 0, (0 << 24), bhvRlMarker),
		...
		OBJECT_WITH_ACTS(MODEL_NONE, 12656, 655, 6438, 0, 0, 0, (0 << 24) | (0 << 16) | (0 << 8), bhvRlSparkle, ACT_6),
		OBJECT(MODEL_NONE, -13000, 900, -2481, 0, 0, 0, 0x00010000, bhvRlSparkle),
		OBJECT(MODEL_NONE, 621, 535, -12283, 0, 0, 0, 0x00010000, bhvRlSparkle),
		OBJECT(MODEL_NONE, 11992, 700, 1327, 0, 0, 0, 0x00010000, bhvRlSparkle),
		OBJECT(MODEL_NONE, 7085, 125, -11727, 0, 0, 0, 0x00010000, bhvRlSparkle),
		OBJECT(MODEL_NONE, -2444, 850, 9756, 0, 0, 0, 0x00010000, bhvRlSparkle),
