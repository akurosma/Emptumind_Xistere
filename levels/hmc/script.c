...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT(MODEL_STAR, 5950, 1100, 11088, 0, 0, 0, (5 << 24), bhvStar),
		...
		OBJECT(MODEL_BOWLING_BALL, 5950, 800, 11088, 0, 0, 0, 0x00000000, bhvRlFirespitter),
		OBJECT(MODEL_NONE, 4500, 500, 8250, 0, -180, 0, (1 << 8), bhvFlamethrower),
		OBJECT(MODEL_NONE, 2250, 500, 7250, 0, 0, 0, (1 << 8), bhvFlamethrower),
		OBJECT(MODEL_NONE, 10625, 671, 12425, 0, -90, 0, (1 << 8), bhvFlamethrower),
		OBJECT(MODEL_NONE, 10625, 854, 10938, 0, -90, 0, (1 << 8), bhvFlamethrower),
