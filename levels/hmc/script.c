...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		//OBJECT(MODEL_NONE, -479, 50, 4367, 0, 0, 0, 0x00000000, bhvBubSpawner),
		//OBJECT(MODEL_NONE, 5792, 50, -10813, 0, 0, 0, 0x00000000, bhvBubSpawner),
		...
		OBJECT(MODEL_HMC_RED_GRILLS, 13763, 1, 8650, 0, 0, 0, (0 << 24) | (0 << 16), bhvRlGate),
		...
		OBJECT(MODEL_RL_TRAIN, -1875, 75, 7750, 0, 0, 0, (1 << 8), bhvRlTrain),
		...
		OBJECT(MODEL_NONE, 4500, 500, 8250, 0, -180, 0, (1 << 8), bhvFlamethrower),
		OBJECT(MODEL_NONE, 2250, 500, 7250, 0, 0, 0, (1 << 8), bhvFlamethrower),
