...
const LevelScript level_hmc_entry[] = {
	...
	AREA(1, hmc_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS, 13763, 1, 8650, 0, 0, 0, (0 << 24) | (0 << 16), bhvRlGate, ACT_6),
		...
		OBJECT(MODEL_NONE, 11992, 700, 1327, 0, 0, 0, 0x00000000, bhvRlSparkle),
		OBJECT(MODEL_NONE, 7085, 125, -11727, 0, 0, 0, (1 << 8), bhvRlSparkle),
		OBJECT(MODEL_RL_BOUNCE, 9425, 500, 9362, 0, 0, 0, (30 << 24), bhvRlSpawnerbounce),
		...
		OBJECT(MODEL_NONE, -10150, 450, 8500, 0, 0, 0, (1 << 16), bhvRlStarindicator),
		OBJECT(MODEL_NONE, -10450, 450, 8500, 0, 0, 0, (2 << 16), bhvRlStarindicator),
		OBJECT(MODEL_NONE, -9850, 250, 8500, 0, 0, 0, (3 << 16), bhvRlStarindicator),
		OBJECT(MODEL_NONE, -10150, 250, 8500, 0, 0, 0, (4 << 16), bhvRlStarindicator),
		OBJECT(MODEL_NONE, -10450, 250, 8500, 0, 0, 0, (5 << 16), bhvRlStarindicator),
