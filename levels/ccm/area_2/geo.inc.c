...
const GeoLayout ccm_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, -100, 0, ccm_dl_area2_test_area2_room_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3800, -1500, 4900, ccm_dl_area2_wallkick_beepblock_mesh_layer_1),
