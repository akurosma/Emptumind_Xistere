...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_RL_SWIMTUBE, -2000, 100, -471, 0, 0, 0, 0x00000000, bhvDebugSound),
		...
		OBJECT(MODEL_RL_SWIMTUBE, -2000, 100, -1129, 0, 0, 0, 0x00000000, bhvMusicSelector),
		...
		OBJECT(MODEL_CCM_RL_SHADOWWALL, 6314, 300, 6463, 0, -90, 0, 0x00000000, bhvRlShadowwall),
		OBJECT(MODEL_CCM_RL_TEMPORESET, 800, 300, -600, 0, 0, 0, (1 << 16), bhvRlTemporeset),
		OBJECT(MODEL_CCM_RL_TEMPORESET, 300, 300, -600, 0, 0, 0, 0x00000000, bhvRlTemporeset),
		OBJECT(MODEL_CCM_RL_TEMPORESET, -200, 300, -600, 0, 0, 0, 0x00000000, bhvRlTemporeset),
		...
		OBJECT(MODEL_NONE, 28, 152, -7898, 0, 0, 0, 0x00000000, bhvRuluHtubeSpeed),
		...
		OBJECT(MODEL_CCM_RL_SPIDERNET, 1333, 300, 533, 0, 0, 0, 0x00000000, bhvRlSpidernet),
