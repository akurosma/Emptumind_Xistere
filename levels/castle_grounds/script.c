...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		WARP_NODE(0xAA, LEVEL_PSS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xB4, LEVEL_WMOTR, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, 0, 0, 1500, 0),
		OBJECT(MODEL_NONE, 0, 1500, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_OW_INFOSWITCH, -750, 1500, -257, 0, 0, 0, 0x00000000, bhvInfoSwitch),
		OBJECT(MODEL_OW_FLOATINGPLATFORM, -1025, 1506, -1769, 0, 0, 0, 0x00000000, bhvSinkPlatform),
		OBJECT(MODEL_NONE, 0, 1500, 0, 0, 0, 0, (2 << 16), bhvPaintingDeathWarp),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, -289, 1500, 883, 0, 0, 0, (1 << 16), bhvWarpPipe),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 408, 1500, 883, 0, 0, 0, (170 << 16), bhvWarpPipe),
		OBJECT(MODEL_CASTLE_GROUNDS_WARP_PIPE, 882, 1500, 883, 0, 0, 0, (180 << 16), bhvWarpPipe),
	...
	AREA(2, castle_grounds_area_2),
		...
		OBJECT(MODEL_OW_INFOSWITCH, 600, 0, 300, 0, 0, 0, (1 << 16), bhvMusicSelector),
