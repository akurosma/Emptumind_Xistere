...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 82, 3306, -7267, 0, 0, 0, 0x00000000, bhvHiddenObject),
		...
		OBJECT(MODEL_NEEDLE, 1950, 3675, -7050, 0, 0, 0, 0x00000000, bhvNeedlePlatform),
		...
		OBJECT(MODEL_WAVE_PLATFORM, 3150, 3675, -11925, 0, 90, -90, (1 << 24) | (7 << 16) | (5 << 8), bhvWaveplatform),
		...
		OBJECT(MODEL_WAVE_PLATFORM, 3150, 3975, -9900, -90, 0, 0, (1 << 24) | (7 << 16) | (5 << 8), bhvWaveplatform),
		OBJECT(MODEL_WAVE_PLATFORM, 3150, 3675, -12975, 0, 90, -90, (1 << 24) | (7 << 16) | (5 << 8), bhvWaveplatform),
		OBJECT(MODEL_WAVE_PLATFORM, 3150, 3675, -14025, 0, 90, -90, (1 << 24) | (7 << 16) | (5 << 8), bhvWaveplatform),
		OBJECT(MODEL_WAVE_PLATFORM, 3150, 3675, -10875, 0, 90, -90, (1 << 24) | (7 << 16) | (5 << 8), bhvWaveplatform),
