...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_NONE, -2100, 2400, -3600, 0, 0, 0, (2 << 24), bhvKeyBlock),
		...
		OBJECT(MODEL_HEART, 600, 2025, -14400, 0, 122, 0, 0x00000000, bhvRecoveryHeart),
		...
		OBJECT(MODEL_NONE, -1500, 2400, -4200, 0, 0, 0, 0x00000000, bhvKeyBlock),
		...
		OBJECT(MODEL_STAR, 3150, 4275, -9150, 0, 0, 0, (0 << 24), bhvStar),
		...
		OBJECT(MODEL_WAVE_PLATFORM, 536, 1525, -2685, 0, -90, 0, (2 << 24) | (3 << 16) | (10 << 8), bhvWaveplatform),
