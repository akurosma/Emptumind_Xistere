...
const GeoLayout bbh_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, 0, -3000, 0, 90, 0, 0, bbh_dl_C5_mesh_layer_4),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, bbh_dl_C5_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bbh_dl_C5_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, 0, -3000, 0, 90, 0, 0, bbh_dl_C5_visual_mesh_layer_4),
