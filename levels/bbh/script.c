...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_BLUE_COIN_SWITCH, 300, 975, -3075, 0, 0, 0, 0x00000000, bhvBlueCoinSwitch),
		...
		OBJECT(MODEL_STAR, -3078, 2589, 6881, 0, 0, 0, 0x00000000, bhvBounceCrystal),
		OBJECT(MODEL_STAR, -3450, 975, -3075, 0, 0, 0, 0x00000000, bhvBounceCrystal),
		OBJECT(MODEL_STAR, -13324, 4039, 2756, 0, 0, 0, 0x00000000, bhvBounceCrystal),
		OBJECT(MODEL_STAR, -12774, 4039, 2756, 0, 0, 0, 0x00000000, bhvBounceCrystal),
		...
		OBJECT(MODEL_GOOMBA, -12274, 7604, 951, 0, 0, 0, (2 << 16), bhvGoomba),
		...
		OBJECT(MODEL_STAR, -14436, 10725, -7077, 0, 0, 0, (2 << 16), bhvStar),
		OBJECT(MODEL_STAR, -12274, 8458, -3143, 0, 0, 0, (3 << 16), bhvStar),
		OBJECT(MODEL_STAR, -12060, 4407, 405, 0, 0, 0, (4 << 16), bhvStar),
