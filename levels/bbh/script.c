...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -450, 450, -8090, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_WOODEN_SIGNPOST, -450, 300, -6750, 0, -180, 0, (169 << 16), bhvMessagePanel),
		OBJECT(MODEL_STAR, 42, 150, -505, 0, 0, 0, 0x00000000, bhvStar),
