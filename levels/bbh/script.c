...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_BLUE_COIN, -1200, 1012, -3983, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -1200, 1012, -4275, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		...
		OBJECT(MODEL_NONE, -450, 1425, -3075, 0, 0, 0, 0x00000000, bhvHiddenRedCoinStar),
		OBJECT(MODEL_STAR, -4602, 2187, -3075, 0, 0, 0, 0x00000000, bhvStar),
