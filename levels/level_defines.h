...
DEFINE_LEVEL("COURSE 4 CCM", LEVEL_CCM, COURSE_CCM, ccm, snow, 20000, 0x1A, 0x1A, 0x1A, _, sCamCCM) 
...
DEFINE_LEVEL("SIC P SEC SLID", LEVEL_PSS, COURSE_PSS, pss, mountain, 20000, 0x00, 0x20, 0x00, _, sCamPSS) 
...
DEFINE_LEVEL("SC2 WMOTR", LEVEL_WMOTR, COURSE_WMOTR, wmotr, generic, 30000, 0x00, 0x00, 0x00, _, sCamWMOtR) 
