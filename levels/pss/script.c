...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_BREAKABLE_BOX, 428, 100, -37, 0, 0, 0, 0x00000000, bhvFloorSwitchHiddenObjects),
		OBJECT(MODEL_YELLOW_COIN, 28, 100, -537, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_RL_180ROTATE, -307, 144, 631, 0, 0, 0, (01 << 16), bhvRl180rotate),
		OBJECT(MODEL_NONE, 0, 752, 0, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 752, 0),
