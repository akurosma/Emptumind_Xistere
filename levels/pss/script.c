...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_YELLOW_COIN, 5966, 0, 6366, 0, 0, 0, 0x00000000, bhvWaterLevelDiamond),
		OBJECT(MODEL_BREAKABLE_BOX, 6400, 0, 7100, 0, 0, 0, 0x00000000, bhvWdwSquareFloatingPlatform),
