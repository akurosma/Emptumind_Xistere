...
extern const BehaviorScript bhvRlWarppad[];
...
extern const BehaviorScript bhvBlackFlameParticle[];
...
extern const BehaviorScript bhvRlPipelamp[];
extern const BehaviorScript bhvRlPipeswitch[];
extern const BehaviorScript bhvRlCcmpipe[];
extern const BehaviorScript bhvHeaveHo[];
extern const BehaviorScript bhvHeaveHoCCM[];
...
extern const BehaviorScript bhvScuttlebugCCM[];
...
extern const BehaviorScript bhvBehaviorkill[];
...
extern const BehaviorScript bhvccmboss[];
extern const BehaviorScript bhvCcmBossWeakSpot[];
