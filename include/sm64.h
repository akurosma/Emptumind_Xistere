...
enum MarioFlags {
    ...
    MARIO_NO_FALLDAMAGE       = /* 0x00000200 */ (1 <<  9),
...
#define ACT_RAIL_GRIND                 0x2081047B // (0x07B | ACT_FLAG_MOVING | ACT_FLAG_RIDING_SHELL | ACT_FLAG_ATTACKING | ACT_FLAG_WATER_OR_TEXT)
...
#define ACT_HYPERTUBE_JUMP             0x0281089D // (0x09D | ACT_FLAG_AIR | ACT_FLAG_RIDING_SHELL | ACT_FLAG_ATTACKING | ACT_FLAG_CONTROL_JUMP_HEIGHT) // rulu hypertube
