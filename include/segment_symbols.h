...
DECLARE_SEGMENT(starrysky_skybox_yay0)
DECLARE_SEGMENT(sunset_skybox_yay0)
DECLARE_SEGMENT(disworld_skybox_yay0)
DECLARE_SEGMENT(blue_ref_skybox_yay0)
DECLARE_SEGMENT(rl_rain1_skybox_yay0)
DECLARE_SEGMENT(rl_rain2_skybox_yay0)
DECLARE_SEGMENT(rl_snow1_skybox_yay0)
DECLARE_SEGMENT(rl_snow2_skybox_yay0)
