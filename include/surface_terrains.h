...
enum SurfaceTypes {
    ...
    SURFACE_SHIFT_PLATFORM,             // 0x0004 // shift_platform_walltype
    ...
    SURFACE_HYPERTUBE_QTE,              // 0x0019 // Hypertube QTE trigger
    ...
    SURFACE_CCM_FALASER,                // 0x0020 // CCM boss final attack laser
    ...
    SURFACE_UPWARD,                     // 0x00A4 // Unused
    SURFACE_DOWNWARD,                   // 0x00A5 // Unused
