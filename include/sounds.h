...
#define SOUND_GENERAL_LOUD_POUND                 /* 0x30180001 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x18, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)//rulu rlbeepblock//0x00, 0) // _TERRAIN?, unverified, unused
