...
#define SOUND_GENERAL_LOUD_POUND2                /* 0x30190001 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x19, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)//rulu rlbeepblock//0x00, 0) // unverified, unused
