...
// ccm boss dash: same sample as STUCK_IN_GROUND, but with higher priority.
#define SOUND_CCM_DASH                            /* 0x0448FF81 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x48, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
// ccm boss walk: same sample as CLAP_HANDS_COLD, but with higher priority.
#define SOUND_CCMBOSS_WALK                       /* 0x062CFF81 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x2C, 0xFF, SOUND_VIBRATO | SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
// CCM boss volcano: max priority, no distance-based volume/priority loss.
#define SOUND_CCM_VOLCANO_0                      /* 0x3F0BFF81 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x0B, 0xFF, SOUND_NO_VOLUME_LOSS | SOUND_NO_PRIORITY_LOSS | SOUND_CONSTANT_FREQUENCY | SOUND_DISCRETE)
...
#define SOUND_GENERAL_LOUD_POUND2                /* 0x30190001 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x19, 0xA0, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)//rulu rlbeepblock//0x00, 0) // unverified, unused
...
#define SOUND_GENERAL_CUSTOM_METAL_SWITCH        /* 0x3078A081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x78, 0xF0, SOUND_DISCRETE)
...
#define SOUND_GENERAL2_CUSTOM_BURN_START         /* 0x3079A081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL2, 0x79, 0xE0, SOUND_DISCRETE)
...
#define SOUND_OBJ2_CCMBOSS_DAMAGE                /* 0x90804081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x80, 0x40, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE)
#define SOUND_OBJ2_CCMBOSS_DIALOG                /* 0x90814081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x81, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ2_CCMBOSS_DIALOG2               /* 0x90824081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x82, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ2_CCMBOSS_DIALOG3               /* 0x90834081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x83, 0x40, SOUND_DISCRETE)
#define SOUND_OBJ2_CCMBOSS_DEATH                 /* 0x9084FF81 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x84, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_OBJ2_FALASER                       /* 0x90854081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x85, 0x40, SOUND_DISCRETE)
